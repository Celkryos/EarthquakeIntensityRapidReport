...
% HCSC - 按周期合成水平时程，并根据 trim_info 裁剪到原始长度。
% 前提：
...
%       .ew, .ns (索引)，以及 .is_valid (由 check_truncated_records 生成)
%
% 输出：
...
%       .pgv_T5_000_h      水平 PGV
%       .sc_T0_100_acc_h   水平合成加速度
%       .pga_T0_100_h      水平 PGA
%       .sc_T0_100_v_h     水平合成速度
%       .pgv_T0_100_h      水平 PGV
